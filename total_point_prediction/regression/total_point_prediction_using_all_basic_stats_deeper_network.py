...
# 4層->8層のニューラルネットワークに変えてみて精度の変化を見てみる
#------------------------------------------------------------------------------
...
#1000 0.34973546862602234
#2000 176.11598587036133
#3000 6.700390338897705
#4000 0.04752109479159117
#5000 3.806782901287079
#6000 0.008104760432615876
#7000 0.019191530533134937
#8000 62.3732328414917
#9000 4.364558935165405
#10000 1.4513731017018472e-07


# レブロンの18歳から32歳までの得点
lebron_pts = torch.Tensor([[
...
model(lebron_pts)
# predict on my machine : 34183.6562



# Scottie Pippenの18歳から32歳までの得点
Scottie_Pippen_pts = torch.Tensor([[
...
Scottie_Pippen_pts = Variable(torch.Tensor(scaler.transform(Scottie_Pippen_pts)))
model(Scottie_Pippen_pts)
# predict on the model:19244.3906
...
Kobe_Bryant_PTS = Variable(torch.Tensor(scaler.transform(Kobe_Bryant_PTS)))
model(Kobe_Bryant_PTS)
# predict on the model：33643
# true total point: 33643


# ジョン・ストックトンの18歳から32歳までの得点
John_Stockton_pts = torch.Tensor([[
...
John_Stockton_pts = Variable(torch.Tensor(scaler.transform(John_Stockton_pts)))
model(John_Stockton_pts)
# predict on the model:21629.4062
# true total point 19711



# Dennis Rodmanの18歳から32歳までの得点
Dennis_Rodman_pts = torch.Tensor([[
...
Dennis_Rodman_pts = Variable(torch.Tensor(scaler.transform(Dennis_Rodman_pts)))
model(Dennis_Rodman_pts)
# predict on my machine:8574.5078
